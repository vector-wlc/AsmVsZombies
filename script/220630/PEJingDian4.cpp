...
#if __AVZ_VERSION__ == 220630 // 这里使用预编译指令是来识别版本号的，使用者不需要声明这些！！！
    OpenMultipleEffective();
    SetZombies({PJ_0, TT_4, WW_8, QS_11, BC_12, XC_15, KG_17, HT_14, FT_21, BY_23,
        HY_32});
    SelectCards({ICE_SHROOM, M_ICE_SHROOM, COFFEE_BEAN, DOOM_SHROOM, LILY_PAD,
        SQUASH, CHERRY_BOMB, BLOVER, PUMPKIN, PUFF_SHROOM});
    SetTime(-599, 1);
